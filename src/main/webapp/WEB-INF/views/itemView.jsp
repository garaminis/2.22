              ...
              <div class="col-sm-6 col-md-3 col-lg-3 mt-60 mb-40scrolling" item="${item.id}" style="padding-left: 10px; padding-right: 10px;">
                <div class="shop-item">
                  ...
                  <div style="text-align: center; padding: 5px;">
                    <div style="width: 100%; height: 300px; overflow: hidden; display: flex; align-items: center; class="shop-item-image">
                      <img style="width: 100%;  " src="/img/coffee/${item.img1}" alt="이미지제대로 넣어라"/>
                    </div>
                    <div>
